...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "public/img/main-thumbnail.png", // public/images/main-thumbnail.jpg 경로에 이미지가 있어야 함
        width: 1200,
        height: 630,
      },
    ],
  ...
  twitter: {
    card: "summary", // 큰 이미지가 있는 카드 형태
    title: "내 식습관 유형은?",
    description: "내 식습관은 어떤 동물 유형일까? 지금 테스트해보세요!",
    images: ["public/img/share-image.png"], // 트위터용 썸네일
